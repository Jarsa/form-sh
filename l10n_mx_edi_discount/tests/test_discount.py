...
class TestDiscount(TransactionCase):
    ...
    def test_01(self):
        ...
        account = self.env["account.account"].search(
            [("user_type_id", "=", user_type.id), ("company_id", "=", invoice.company_id.id)], limit=1
        )
        ...
        self.assertEqual(round(invoice_dict["l10n_mx_edi_total_discount"], dp.precision_get("Discount")), 1.91)
    ...
    def test_02_compute_discount(self):
        ...
        invoice._compute_discount()
        self.assertEqual(round(invoice.l10n_mx_edi_total_discount, discount_digits), 1652.66)
