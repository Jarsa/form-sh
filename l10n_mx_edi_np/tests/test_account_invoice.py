...
class TestL10nMxEdiInvoiceNP(TestMxEdiCommon):
    def setUp(self):
        super().setUp()
        self.user_billing.partner_id.write({"l10n_mx_edi_curp": "TICE700419HCLJND07"})
    ...
    def test_l10n_mx_edi_np_single(self):
        ...
        namespaces = {"notariospublicos": "http://www.sat.gob.mx/notariospublicos"}
        comp = xml.Complemento.xpath("//notariospublicos:NotariosPublicos", namespaces=namespaces)
    ...
    def test_l10n_mx_edi_np_multiple(self):
        ...
        xml = fromstring(generated_files[0])
        namespaces = {"notariospublicos": "http://www.sat.gob.mx/notariospublicos"}
        comp1 = xml.Complemento.xpath("//notariospublicos:DatosEnajenantesCopSC", namespaces=namespaces)
        comp2 = xml.Complemento.xpath("//notariospublicos:DatosAdquirientesCopSC", namespaces=namespaces)
        self.assertTrue(comp1 and comp2, "Notary Public Complement not added correctly")
