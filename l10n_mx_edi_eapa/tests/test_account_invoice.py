...
class TestL10nMxEdiInvoiceEAPA(TestMxEdiCommon):
    def test_l10n_mx_edi_invoice_eapa(self):
        ...
        namespaces = {"obrasarte": "http://www.sat.gob.mx/arteantiguedades"}
        eapa = xml.Complemento.xpath("//obrasarte:obrasarteantiguedades", namespaces=namespaces)
    ...
    def test_l10n_mx_edi_xsd(self):
        ...
        xsd_file = self.ref("l10n_mx_edi.xsd_cached_obrasarteantiguedades_xsd")
    ...
    def test_invoice_payment_in_kind(self):
        ...
        namespaces = {"pagoenespecie": "http://www.sat.gob.mx/pagoenespecie"}
        comp = xml.Complemento.xpath("//pagoenespecie:PagoEnEspecie", namespaces=namespaces)
    ...
    def create_donation_line(self, invoice, product):
        ...
        invoice_line_dict = invoice_line._convert_to_write({name: invoice_line[name] for name in invoice_line._cache})
