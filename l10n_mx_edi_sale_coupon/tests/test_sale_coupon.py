...
class TestSaleCoupon(TransactionCase):
    ...
    def test_001_coupon_on_order(self):
        ...
        self.assertTrue(
            float_is_zero(float_compare(total_inv, total_sale, 2), 2),
        ...
        self.assertTrue(
            all(invoice_lines.mapped("l10n_mx_edi_amount_discount")), "All normal invoice lines must have discount"
        )
    ...
    def test_004_promotion_on_specific_products(self):
        ...
        self.assertFalse(
            sale.order_line.mapped("invoice_lines").filtered(lambda l: l.price_total < 0),
    ...
    def test_005_fixed_amount_promotions(self):
        ...
        promotions = self.coupon_program.create(
            {
                ...
                "discount_fixed_amount": 939.66,
                "promo_code_usage": "no_code_needed",
                "program_type": "promotion_program",
                "rule_products_domain": '["&",["sale_ok","=",True],["default_code","=","%s"]]'
        ...
        total_inv = round(sale.order_line.mapped("invoice_lines.move_id").amount_total, 0)
        self.assertTrue(
            float_is_zero(total_inv - total_sale, 2),
            "The invoice total is different to the sale order. %s != %s" % (total_inv, total_sale),
        )
