...
class TestL10nMxEdiInvoiceVoucher(TestMxEdiCommon):
    def test_l10n_mx_edi_voucher_invoice(self):
        ...
        cfdi_date = datetime.combine(
            fields.Datetime.from_string(invoice.invoice_date), invoice.l10n_mx_edi_post_time.time()
        ...
        namespaces = {"valesdedespensa": "http://www.sat.gob.mx/valesdedespensa"}
        comp = xml.Complemento.xpath("//valesdedespensa:ValesDeDespensa", namespaces=namespaces)
        self.assertXmlTreeEqual(comp[0], xml_expected)
