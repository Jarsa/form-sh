odoo.define("pos_cfdi_usage.CFDIUsageScreen", (require) => {
    ...
    class CFDIUsageScreen extends PosComponent {
        ...
        get usages() {
            ...
            return query ? this.env.pos.search_usage_selection(query) : this.env.pos.usage_selection;
        }
        ...
        clickNext() {
            this.state.selectedUsage = this.nextButton.command === "set" ? this.state.selectedUsage : null;
            this.confirm();
        }
    }
