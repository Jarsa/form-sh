...
1. The cancel process in Odoo, only could be executed when the SAT status
   is cancelled for cancellation type 02, 03 and 04.
2. The cancel process can not be executed if the invoice is paid.
3. Group to hide Odoo button to cancel was added.
4. New setting to enable the invoice/payment cancellation from previous periods with reversal moves.
5. Add group for users who can manage cancellation from previous periods.
6. New option to cancel with reversal invoices on closed periods.
