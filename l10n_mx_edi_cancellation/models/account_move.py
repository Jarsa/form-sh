...
class AccountMove(models.Model):
    ...
    @api.depends("restrict_mode_hash_table", "state", "l10n_mx_edi_cancellation")
    ...
    def button_cancel(self):
        ...
        return super(AccountMove, (to_cancel - to_request).with_context(called_from_cron=True)).button_cancel()
