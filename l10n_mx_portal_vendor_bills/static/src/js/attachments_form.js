...
//             if (status !== "success") {
//                 // Restore send button behavior if result is an error
//                 this.$target.find(".btn_upload_attachments").on("click", function (e) {
//                     self.send(e);
//                 });
//             }
...
//                     errorMessages +=
//                         _t('<div><span level="1">The XML Supplier</span> was not found: <span level="2">') +
//                         val +
//                         "</span>.</div>";
//                 } else if (ikey === "rfc") {
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The XML Receptor RFC</span> does not match with <span level="1">your Company RFC</span>: '
//                         ) +
//                         _t('XML Receptor RFC: <span level="2">') +
//                         val[0] +
//                         _t(', </span> Your Company RFC: <span level="2">') +
//                         val[1] +
//                         "</span></div>";
//                 } else if (ikey === "currency") {
//                     errorMessages +=
//                         _t('<div><span level="1">The XML Currency</span> <span level="2">') +
//                         val +
//                         _t("</span> was not found or is disabled.</div>");
//                 } else if (ikey === "taxes") {
//                     errorMessages +=
//                         _t('<div><span level="1">Some taxes</span> do not exist for purchases: <span level="2">') +
//                         val.join(", ") +
//                         "</span>.</div>";
//                 } else if (ikey === "signed") {
...
//                 } else if (ikey === "cancel") {
//                     errorMessages += _t(
//                         '<div><span level="1">The XML state</span> is CANCELED in the SAT system.</div>'
//                     );
//                 } else if (ikey === "discount") {
//                     errorMessages += _t(
//                         '<div><span level="1">Unable to generate invoices with discounts from an XML with version 3.2.</span>You can create the invoice manually and then attach the xml.</div>'
//                     );
//                 } else if (ikey === "folio") {
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The XML Folio</span> does not match with <span level="1">Supplier Invoice Number</span>: '
//                         ) +
//                         _t('XML Folio: <span level="2">') +
//                         val[0] +
//                         _t(', </span> Supplier invoice number: <span level="2">') +
//                         val[1] +
//                         "</span></div>";
//                 } else if (ikey === "rfc_supplier") {
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The XML Emitter RFC</span> does not match with <span level="1">Customer RFC</span>: '
//                         ) +
//                         _t('XML Emitter RFC: <span level="2">') +
//                         val[0] +
//                         _t(', </span> Customer RFC: <span level="2">') +
//                         val[1] +
//                         "</span></div>";
//                 } else if (ikey === "amount") {
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The XML amount total</span> does not match with <span level="1">Invoice total</span>: '
//                         ) +
//                         _t('XML amount total: <span level="2">') +
//                         val[0] +
//                         _t(', </span> Invoice Total: <span level="2">') +
//                         val[1] +
//                         "</span></div>";
//                 } else if (ikey === "uuid_duplicate") {
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The XML UUID</span> belongs to other invoice. <span level="1">UUID: </span>'
//                         ) +
//                         val +
//                         "</div>";
...
//                     errorMessages +=
//                         _t(
//                             '<div><span level="1">The invoice reference</span> belongs to other invoice of the same partner. <span level="1">Partner: </span>'
//                         ) +
//                         val[0] +
//                         _t('<span level="1"> Reference: </span>') +
//                         val[1] +
//                         "</div>";
