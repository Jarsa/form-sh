...
class TestL10nMxEdiInvoiceAirline(TestMxEdiCommon):
    ...
    def test_invoice_airline_no_extra_charges(self):
        ...
        invoice.invoice_line_ids = [self.create_airline_line(self.tua, invoice.id)]
        invoice.action_post()
        ...
        namespaces = {"aerolineas": "http://www.sat.gob.mx/aerolineas"}
        comp = xml.Complemento.xpath("//aerolineas:Aerolineas", namespaces=namespaces)
    ...
    def test_invoice_airline_extra_charges(self):
        ...
        xml = fromstring(generated_files[0])
        namespaces = {"aerolineas": "http://www.sat.gob.mx/aerolineas"}
        comp = xml.Complemento.xpath("//aerolineas:OtrosCargos", namespaces=namespaces)
        self.assertTrue(comp, "Complement to Airlines not added correctly")
