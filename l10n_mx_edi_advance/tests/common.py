        ...
        taxes.write(
            {
                ...
                .search([("code", "=", "209.01.01"), ("company_id", "=", self.invoice.company_id.id)])
                .id,
                # 'cash_basis_base_account_id':  self.env['account.account'].search([
                #     ('code', '=', '899.01.99'), ('company_id', '=', self.invoice.company_id.id)]).id,
            }
        )
