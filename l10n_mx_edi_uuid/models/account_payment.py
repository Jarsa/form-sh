...
class AccountPayment(models.Model):
    ...
    l10n_mx_edi_cfdi_uuid = fields.Char(
        "Fiscal Folio", compute="_compute_l10n_mx_edi_cfdi_uuid", search="_search_l10n_mx_edi_cfdi_uuid"
    )
    ...
    def _search_l10n_mx_edi_cfdi_uuid(self, operator, value):
        attachments = self.env["ir.attachment"].search_read(
            [("res_model", "=", "account.move"), ("l10n_mx_edi_cfdi_uuid", operator, value)], ["res_id"]
        )
