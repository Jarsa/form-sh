...
class TestSplitPayment(TestMxEdiCommon):
    ...
    def setUpClass(cls, chart_template_ref="l10n_mx.mx_coa", edi_format_ref="l10n_mx_edi.edi_cfdi_3_3"):
        ...
        cls.fake_eur_data = cls.setup_multi_currency_data(
            default_values={
                "name": "EUR",
                "symbol": "€",
                "rounding": 0.01,
        ...
        cls.fake_usd_data["rates"][0].rate = 1 / 20
        cls.fake_usd_data["rates"][1].rate = 1 / 25
        cls.fake_eur_data["rates"][0].rate = 1 / 22.50
        cls.fake_eur_data["rates"][1].rate = 1 / 24.75
    ...
    def create_payment(
        ...
        register.l10n_mx_edi_payment_method_id = invoices[-1].l10n_mx_edi_payment_method_id
        if csv:
                        ...
                        <Complemento>
                            <Pagos Version="2.0">
                                ...
                                <Pago
                                    ...
                                    NumOperacion="INV/2016/12/0001 INV/2016/12/0002 INV/2016/12/0003">
                                        <DoctoRelacionado
                                            IdDocumento="123456789" Folio="1" Serie="INV/2016/12/"
                                            MonedaDR="MXN" NumParcialidad="1" ObjetoImpDR="01" EquivalenciaDR="1"
                                            ImpSaldoAnt="100.00" ImpPagado="90.00" ImpSaldoInsoluto="10.00"/>
                                        <DoctoRelacionado
                                            EquivalenciaDR="0.0500000000"
                                            IdDocumento="567891234" Folio="2" Serie="INV/2016/12/"
                                            MonedaDR="USD" NumParcialidad="1" ObjetoImpDR="01"
                                            ImpSaldoAnt="5.00" ImpPagado="4.00" ImpSaldoInsoluto="1.00"/>
                                        <DoctoRelacionado
                                            EquivalenciaDR="0.0434782609"
                                            IdDocumento="987654321" Folio="3" Serie="INV/2016/12/"
                                ...
                                <Pago
                                    ...
                                    NumOperacion="INV/2016/12/0001 INV/2016/12/0002 INV/2016/12/0003">
                                        ...
                                        <DoctoRelacionado
                                            ...
                                            ImpSaldoAnt="5.00" ImpPagado="5.00" ImpSaldoInsoluto="0.00"/>
                                        <DoctoRelacionado
                                            EquivalenciaDR="1" IdDocumento="987654321" Folio="3" Serie="INV/2016/12/"
                                            MonedaDR="EUR" NumParcialidad="1" ObjetoImpDR="01"
                                            ImpSaldoAnt="4.40" ImpPagado="4.40" ImpSaldoInsoluto="0.00"/>
                                    </Pago>
                            </Pagos>
