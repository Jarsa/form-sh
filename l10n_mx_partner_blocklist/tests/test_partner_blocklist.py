...
class TestL10nMxPartnerBlocklist(TestMxEdiCommon):
    ...
    def test_partner_blocklist(self):
        ...
        try:
            ...
            self.assertEqual(
                self.partner_camptocamp.l10n_mx_in_blocklist, "blocked", "The Sale Order has been confirmed"
            )
        ...
        try:
            ...
            self.assertEqual(
                self.partner_camptocamp.l10n_mx_in_blocklist, "blocked", "The Purchase Order has been confirmed"
            )
        except ValidationError as e:
            self.assertEqual(raise_msg, e.name[:29])
