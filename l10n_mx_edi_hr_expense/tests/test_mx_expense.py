...
class EdiHrExpense(TransactionCase):
    ...
    def test_create_expense_from_cfdi40_basic_flow(self):
        ...
        self.assertTrue(expense.l10n_mx_edi_sat_status == "not_found", "UUID extracted incorrectly")
        ...
        sheet = self.env["hr.expense.sheet"].with_context(**data["context"]).create({"name": "%s" % expense.name})
    ...
    def test_create_partner_from_cfdi(self):
        ...
        self.env["res.partner"].sudo().search([("vat", "=", "EKU9003173C9")]).write({"active": False})
    ...
    def test_expense_state(self):
        ...
        expense.l10n_mx_edi_revert_expense()
    ...
    def test_expense_by_email(self):
        ...
        self.env.company.sudo().expense_extract_show_ocr_option_selection = False
