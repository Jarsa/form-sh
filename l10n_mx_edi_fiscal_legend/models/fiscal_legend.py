...
class FiscalLegend(models.Model):
    ...
    name = fields.Char(string="Legend Text", required=True, help="Text to specify the fiscal legend.")
    ...
    rule = fields.Char(help="Specifies the Article number or rule that regulates the obligation of this legend.")
